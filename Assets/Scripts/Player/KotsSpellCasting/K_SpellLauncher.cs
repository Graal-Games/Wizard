...
public class K_SpellLauncher : NetworkBehaviour
{
    ...
    private void HandleSpellCasting()
    {
        ...
        if (key != KeyCode.None)
        {
            ...
            InitCastProcudure(); // (exists in one other place in this script) This can be replaced by InitiateCastProcedure(spellSequence);
        } 
    }
