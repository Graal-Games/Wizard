...
public abstract class K_Spell : NetworkBehaviour
{
    ...
    GameObject lifetimeGameObjectToDestroy;
    ...
    {
        lifetimeGameObjectToDestroy = spellObj;
    ...
    {
        Debug.LogFormat($"<color=pink>gameObjectgameObjectgameObject {lifetimeGameObjectToDestroy}</color>");

        Destroy(lifetimeGameObjectToDestroy);
        if (lifetimeGameObjectToDestroy.GetComponent<NetworkObject>() != null)
        {
            lifetimeGameObjectToDestroy.GetComponent<NetworkObject>().Despawn();
        } else
        {
            lifetimeGameObjectToDestroy.GetComponentInParent<NetworkObject>().Despawn();
        }
    }
